...
public class Quanlynguoidung extends javax.swing.JPanel {
        ...
        loadBangNguoiDung();
         jTable3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (selectedRow >= 0) {
                    jTextField4.setText(jTable1.getValueAt(selectedRow, 0).toString());
         ...
         jTable3.addMouseListener(new java.awt.event.MouseAdapter() {
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        dienThongTinNguoiDungTuBang();
    }
        });
    }
    //load thông tin người dùng 
    private void loadBangNguoiDung() {
    jTable3.setModel(dao.layTatCaNguoiDung());
}
    // điền thông tin vào bảng khi nhấn
    private void dienThongTinNguoiDungTuBang() {
    int selectedRow = jTable3.getSelectedRow();
    if (selectedRow >= 0) {
        jTextField4.setText(jTable3.getValueAt(selectedRow, 0).toString()); // ID
        jTextField1.setText(jTable3.getValueAt(selectedRow, 1).toString()); // Họ tên
        jTextField3.setText(jTable3.getValueAt(selectedRow, 2).toString()); // Email
        jTextField2.setText(jTable3.getValueAt(selectedRow, 3).toString()); // Số điện thoại
    }
}
    ...
    dao.suaNguoiDung(id, ten, email, sdt);
    loadBangNguoiDung();
